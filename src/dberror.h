...
#define RC_NULLTABLE 17
#define RC_NULLCONDITION 18
#define RC_RM_CREATE_TABLE_ERROR 19
#define RC_RM_RECORD_NOT_FOUND_ERROR 20
#define RC_RM_TABLE_DATA_NOT_INIT 21
